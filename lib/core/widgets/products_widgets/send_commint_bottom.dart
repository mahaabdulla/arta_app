...
class SendCommintBlueBottom extends StatelessWidget {
  final VoidCallback onTap;

  const SendCommintBlueBottom({
    super.key,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap, // عند الضغط على الزر سيتم تنفيذ ال onTap الذي سيتم تمريره
      child: Container(
        width: 200,
        height: 60,
        decoration: BoxDecoration(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            SvgPicture.asset(sendCommint), // يمكنك هنا إضافة أي صورة تريدها
            const SizedBox(width: 5),
            Text(
              'ارسال التعليق',
              style:
